...
if (/^[NJR]\d+$/.test(v)) return v[0]===‘N’?“nuit”:v[0]===‘J’?“jour”:“repos”;
if (/^[NJR]/.test(v)&&v.length<=6) return v[0]===‘N’?“nuit”:v[0]===‘J’?“jour”:“repos”;
